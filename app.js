//Create two time line one for enter and one for leave
...
const enterAnimation = (current,done, gradient) => {
    ...
    return(
        ...
        tlEnter.fromTo(text,{y:100, opacity:0}, {opacity:1, y:00}, "<"),
        tlEnter.fromTo(circles, {y:-20, opacity:0}, {y:00, opacity:1, stagger:0.15, ease:"back.out(1.7)", duration:1},"<")
        );
}
    ...
    transitions:[
        ...
        //Product page 
        {
            ...
            leave(data){
                ...
                proudctLeaveAnimation(current, done);
            }
        }
    ]
})
...
function proudctLeaveAnimation(current,done){
